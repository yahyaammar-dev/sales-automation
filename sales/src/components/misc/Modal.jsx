    ...
    useEffect(() => {
        // When selectedMessage changes, play the associated audio
        if (selectedMessage && audioRef.current) {
            ...
            >
                ...
                <div className="chatroom bg-white font-sans">
                        ...
                        {index % 2 === 0 ? (
                            ...
                            <div>
                                ...
                                <div className="flex items-center justify-start gap-2">
                                    ...
                                    <p>{message.date}</p>
                                    <button onClick={()=>handlePlayMessage(message)}>
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        fill="none"
                                        viewBox="0 0 24 24"
                                ...
                                <div className="flex">
                                    <p>
                                    Matching Keyword: {message.matchingKeywords}
                                    </p>
                                    {/* Rest of your matching keyword logic */}
                                </div>
                                </div>
                    ...
                    <audio ref={audioRef} controls >
                     ...
                     <audio ref={myref} controls >
                         <source src='http://103.18.20.195:8080/speech/1001-1690571848.52-1690571850.wav' style={{display: 'none'}} type="audio/wav" />
                    </audio>
                    </div>
                </div>
                </div>
